...
model = dict(
    ...
    backbone=dict(
        type="SpMiddleResNetFHD", num_input_features=16, ds_factor=8, #init_channel=32
    ),  ##todo num_input_features=4, # to add the init_channel=16->32
    # neck=dict(
    #     type="RPN",
    #     layer_nums=[5, 5],
    ...
    # ),
    neck=dict(
        type="RPN_transformer_deformable_mtf",  #RPN_transformer
...
assigner = dict(
    ...
    out_size_factor=4,  #get_downsample_factor(model),
    dense_reg=1,
