...
model = dict(
    ...
    neck=dict(
        type="RPN_transformer_deformable_multitask_mtf_refactor_singlestage",
        ds_num_filters=[256, 256, 128],
        multiscale_neck=dict(
            type="MultiscaleNeckPillarNet",
            layer_nums=[5, 5, 1],
            ds_num_filters=[256, 256, 128],
...
# val_anno = "data/nuScenes/mini_infos_val_10sweeps_withvelo_filter_True.pkl"
test_anno = None
